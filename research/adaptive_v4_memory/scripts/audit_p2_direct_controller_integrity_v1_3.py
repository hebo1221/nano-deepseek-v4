...
if globals().get("SEALED_LAUNCH_AUTHORITY_V1_3_1") is not None:
    matrix.SEALED_LAUNCH_AUTHORITY_V1_3_1 = dict(
        cast(Mapping[str, Any], SEALED_LAUNCH_AUTHORITY_V1_3_1)
    )
    matrix.SEALED_PYTHON_RUNTIME_V1_3_1 = dict(
        cast(Mapping[str, Any], SEALED_PYTHON_RUNTIME_V1_3_1)
    )
    matrix.SEALED_SOURCE_PROVENANCE_V1_3_1 = dict(
        cast(Mapping[str, Any], SEALED_SOURCE_PROVENANCE_V1_3_1)
    )

EXPERIMENT_ID = contract.V1_3_1_INTEGRITY_EXPERIMENT_ID
ARTIFACT_TYPE = "direct-controller-exact-fill-closed-world-integrity-audit"
SCHEMA_VERSION = 1
ATTESTATION_PURPOSE = contract.V1_3_1_INTEGRITY_ATTESTATION_PURPOSE
INTEGRITY_OUTPUT = contract.V1_3_1_INTEGRITY_OUTPUT_PATH
AUDIT_BOUNDARY = (
