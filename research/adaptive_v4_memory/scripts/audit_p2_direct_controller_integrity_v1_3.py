...
if globals().get("SEALED_LAUNCH_AUTHORITY_V1_3_3") is not None:
    matrix.SEALED_LAUNCH_AUTHORITY_V1_3_3 = dict(
        cast(Mapping[str, Any], SEALED_LAUNCH_AUTHORITY_V1_3_3)
    )
    matrix.SEALED_PYTHON_RUNTIME_V1_3_3 = dict(
        cast(Mapping[str, Any], SEALED_PYTHON_RUNTIME_V1_3_3)
    )
    matrix.SEALED_SOURCE_PROVENANCE_V1_3_3 = dict(
        cast(Mapping[str, Any], SEALED_SOURCE_PROVENANCE_V1_3_3)
    )

EXPERIMENT_ID = contract.V1_3_3_INTEGRITY_EXPERIMENT_ID
ARTIFACT_TYPE = "direct-controller-exact-fill-closed-world-integrity-audit"
SCHEMA_VERSION = 1
ATTESTATION_PURPOSE = contract.V1_3_3_INTEGRITY_ATTESTATION_PURPOSE
INTEGRITY_OUTPUT = contract.V1_3_3_INTEGRITY_OUTPUT_PATH
AUDIT_BOUNDARY = (
...
def _validate_quality_start_activation_binding(
    ...
    *,
    ...
    context = matrix.admission.establish_v1_3_3_quality_context(
